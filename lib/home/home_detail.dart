...
class HomeDetailView extends StatefulWidget {
  const HomeDetailView(this.tests, {Key? key}) : super(key: key);
...
class _HomeDetailViewState extends State<HomeDetailView> {
  ...
  void resultDialog() {
    int correctAnswers = answers.where((answer) => answer).length;
    int incorrectAnswers = answers.length - correctAnswers;
